...
import {
  ...
  ENEMY_EARTH_SLIME_BREATH_OUTLINE_SCALE,
  ENEMY_EARTH_SLIME_BREATH_SCALE_Y_MAX,
  ENEMY_EARTH_SLIME_BREATH_SCALE_Y_MIN,
  ENEMY_EARTH_SLIME_BREATH_DURATION_MS,
  ENEMY_EARTH_ROCK_BREATH_SPRITE_KEY,
  ENEMY_EARTH_ROCK_BREATH_DISPLAY_HEIGHT,
  ENEMY_EARTH_ROCK_BREATH_OUTLINE_SCALE,
  ENEMY_EARTH_ROCK_BREATH_SCALE_Y_MAX,
  ENEMY_EARTH_ROCK_BREATH_SCALE_Y_MIN,
  ENEMY_EARTH_ROCK_BREATH_DURATION_MS,
  ENEMY_EARTH_MAGMA_ROCK_BREATH_SPRITE_KEY,
  ENEMY_EARTH_MAGMA_ROCK_BREATH_DISPLAY_HEIGHT,
  ENEMY_EARTH_MAGMA_ROCK_BREATH_OUTLINE_SCALE,
  ENEMY_EARTH_MAGMA_ROCK_BREATH_SCALE_Y_MAX,
  ENEMY_EARTH_MAGMA_ROCK_BREATH_SCALE_Y_MIN,
  ENEMY_EARTH_MAGMA_ROCK_BREATH_DURATION_MS,
  ...
  ENEMY_EARTH_SKELETON_BREATH_OUTLINE_SCALE,
  ENEMY_EARTH_SKELETON_BREATH_SCALE_Y_MAX,
  ENEMY_EARTH_SKELETON_BREATH_SCALE_Y_MIN,
  ENEMY_EARTH_SKELETON_BREATH_DURATION_MS,
  ...
  ENEMY_WIND_HIVE_BOSS_BREATH_OUTLINE_SCALE,
  ENEMY_WIND_HIVE_BOSS_BREATH_SCALE_Y_MAX,
  ENEMY_WIND_HIVE_BOSS_BREATH_SCALE_Y_MIN,
  ENEMY_WIND_HIVE_BOSS_BREATH_DURATION_MS,
  ENEMY_EARTH_DUNGEON_BOSS_BREATH_SPRITE_KEY,
  ENEMY_EARTH_DUNGEON_BOSS_BREATH_DISPLAY_HEIGHT,
  ENEMY_EARTH_DUNGEON_BOSS_BREATH_OUTLINE_SCALE,
  ENEMY_EARTH_DUNGEON_BOSS_BREATH_SCALE_Y_MAX,
  ENEMY_EARTH_DUNGEON_BOSS_BREATH_SCALE_Y_MIN,
  ENEMY_EARTH_DUNGEON_BOSS_BREATH_DURATION_MS,
...
/** Earth Dungeon Stage1 の土スライム（緑スライムと同じ呼吸・向き）。 */
export function attachEarthSlimeBreathingSprite(
  scene: Phaser.Scene,
  enemy: Phaser.GameObjects.Rectangle,
): void {
  attachBreathingEnemySprite(
...
/** Earth Dungeon Stage2 の岩敵（緑スライムと同じ呼吸・向き）。 */
export function attachEarthRockBreathingSprite(
  scene: Phaser.Scene,
  enemy: Phaser.GameObjects.Rectangle,
): void {
  attachBreathingEnemySprite(
...
/** Earth Dungeon Stage4 マグマ岩（左向き・移動で反転・呼吸）。 */
export function attachEarthMagmaRockBreathingSprite(
  scene: Phaser.Scene,
  enemy: Phaser.GameObjects.Rectangle,
): void {
  attachBreathingEnemySprite(
...
/** Earth Dungeon Stage3 のスケルトン（カブトムシと同じ呼吸・向き）。 */
export function attachEarthSkeletonBreathingSprite(
  scene: Phaser.Scene,
  enemy: Phaser.GameObjects.Rectangle,
): void {
  attachBreathingEnemySprite(
...
/** Wind Plains Stage3 ボス（正面顔・移動で左右反転・呼吸）。 */
export function attachWindHiveBossBreathingSprite(
  scene: Phaser.Scene,
  enemy: Phaser.GameObjects.Rectangle,
): void {
  attachBreathingEnemySprite(
...
/** Earth Dungeon Stage5 ボス（左向き基準・移動で左右反転・呼吸）。 */
export function attachEarthDungeonBossBreathingSprite(
  scene: Phaser.Scene,
  enemy: Phaser.GameObjects.Rectangle,
): void {
  attachBreathingEnemySprite(
