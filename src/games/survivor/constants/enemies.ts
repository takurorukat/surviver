...
/** 小石発射間隔。旧 5000ms ÷1.5 → 3333ms */
export const ENEMY_EARTH_ROCK_PEBBLE_INTERVAL_MS = 3333
/** 発射前の予備動作合計（縮小＋膨張） */
export const ENEMY_EARTH_ROCK_ATTACK_WINDUP_MS = 450
export const ENEMY_EARTH_ROCK_ATTACK_SHRINK_MS = 180
export const ENEMY_EARTH_ROCK_ATTACK_SWELL_MS = 270
export const ENEMY_EARTH_ROCK_ATTACK_SHRINK_SCALE = 0.82
export const ENEMY_EARTH_ROCK_ATTACK_SWELL_SCALE = 1.18
export const ENEMY_EARTH_ROCK_ATTACK_RECOVER_MS = 100
...
/**
 * Ruins Stage2 で Volcano Stage2 敵を混ぜる確率。
 * 残りは earthRock。Volcano 側の内訳は既存ウェイトを再利用する。
 */
export const RUINS_STAGE2_VOLCANO_ENEMY_CHANCE = 0.2
// Earth Dungeon Stage4: マグマ岩（6方向小石放射）
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_SPRITE_KEY = 'enemy-earth-magma-rock-breath'
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_SPRITE_PATH =
  'assets/sprites/enemy_earth_magma_rock_breath.png'
/** 当たり判定用スケール（スライム比）。見た目とは分離する */
export const ENEMY_EARTH_MAGMA_ROCK_SIZE_SCALE = 1.5
/** 表示スケール = 判定スケールの 1.5 倍（見た目だけ大きくする） */
export const ENEMY_EARTH_MAGMA_ROCK_DISPLAY_SCALE =
  ENEMY_EARTH_MAGMA_ROCK_SIZE_SCALE * 1.5
export const ENEMY_EARTH_MAGMA_ROCK_WIDTH =
  ENEMY_WIDTH * ENEMY_EARTH_MAGMA_ROCK_SIZE_SCALE
export const ENEMY_EARTH_MAGMA_ROCK_HEIGHT =
  ENEMY_HEIGHT * ENEMY_EARTH_MAGMA_ROCK_SIZE_SCALE
export const ENEMY_EARTH_MAGMA_ROCK_RADIUS =
  ENEMY_RADIUS * ENEMY_EARTH_MAGMA_ROCK_SIZE_SCALE
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_DISPLAY_HEIGHT =
  ENEMY_HEIGHT * ENEMY_EARTH_MAGMA_ROCK_DISPLAY_SCALE
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_OUTLINE_SCALE =
  ENEMY_SLIME_BREATH_OUTLINE_SCALE
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_SCALE_Y_MAX =
  ENEMY_SLIME_BREATH_SCALE_Y_MAX
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_SCALE_Y_MIN =
  ENEMY_SLIME_BREATH_SCALE_Y_MIN
export const ENEMY_EARTH_MAGMA_ROCK_BREATH_DURATION_MS =
  ENEMY_SLIME_BREATH_DURATION_MS
export const ENEMY_EARTH_MAGMA_ROCK_COLOR = 0x57534e
export const ENEMY_EARTH_MAGMA_ROCK_HP = 72
export const ENEMY_EARTH_MAGMA_ROCK_SPEED_FACTOR = 0.55
export const ENEMY_EARTH_MAGMA_ROCK_XP_DROP_MULTIPLIER = 4
export const ENEMY_EARTH_MAGMA_ROCK_ATTACK_INTERVAL_MS = 2500
export const ENEMY_EARTH_MAGMA_ROCK_WINDUP_MS = 700
export const ENEMY_EARTH_MAGMA_ROCK_RADIAL_COUNT = 6
export const ENEMY_EARTH_MAGMA_ROCK_PEBBLE_SPEED_FACTOR = 0.8
export const ENEMY_EARTH_MAGMA_ROCK_ATTACK_SWELL_SCALE = 1.22
export const ENEMY_EARTH_MAGMA_ROCK_MAX_ACTIVE = 4
/** Stage4 抽選でマグマ岩が出る相対重み（他3種と同列時に約22%） */
export const ENEMY_EARTH_MAGMA_ROCK_STAGE4_WEIGHT = 22
export const ENEMY_EARTH_STAGE4_OTHER_WEIGHT = 26
// 小石弾（コード生成テクスチャ）
...
export const ENEMY_CHAOS_ELEMENTAL_HP = 225 // 旧 150 の 1.5 倍
// 下位ステージの敵を出す間隔。旧 2000ms ÷1.5 → 1333ms
export const ENEMY_CHAOS_ELEMENTAL_SPAWN_INTERVAL_MS = 1333
...
export const ENEMY_GRAVESTONE_HP = 270 // 旧 180 の 1.5 倍（さらに旧 120 の系譜）
export const ENEMY_GRAVESTONE_XP_DROP_MULTIPLIER = 10
export const ENEMY_GRAVESTONE_COLOR = 0x6b7280
// 召喚間隔。旧 4000ms を ÷1.5 → 2667ms
export const ENEMY_GRAVESTONE_SPAWN_INTERVAL_MS = 2667
...
// 従来 Runtime 表示（1.5）の 1.5 倍 → 2.25
export const ENEMY_WIND_HIVE_BOSS_SIZE_SCALE = 2.25
...
// 旧 75 の 1.5 倍
export const ENEMY_WIND_HIVE_BOSS_HP = 113
export const ENEMY_WIND_HIVE_BOSS_XP_DROP_MULTIPLIER = 10
// 通常スライム速度（ENEMY_BASE_SPEED）の 0.75 倍（旧 0.5 の 1.5 倍）
export const ENEMY_WIND_HIVE_BOSS_SPEED_FACTOR = 0.75
export const ENEMY_WIND_HIVE_BOSS_COLOR = 0xd2b48c
// 蜂召喚間隔。旧 4000ms を ÷1.5 → 2667ms
export const ENEMY_WIND_HIVE_BOSS_BEE_SPAWN_INTERVAL_MS = 2667
...
// Earth Dungeon Stage5 最終ボス（ゴーレム・接近・敵召喚・小石5連射）
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_SPRITE_KEY = 'enemy-earth-dungeon-boss-breath'
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_SPRITE_PATH =
  'assets/sprites/enemy_earth_dungeon_boss.png'
export const ENEMY_EARTH_DUNGEON_BOSS_SIZE_SCALE = 5 // 旧 2 の 2.5 倍
export const ENEMY_EARTH_DUNGEON_BOSS_WIDTH =
  ENEMY_WIDTH * ENEMY_EARTH_DUNGEON_BOSS_SIZE_SCALE
export const ENEMY_EARTH_DUNGEON_BOSS_HEIGHT =
  ENEMY_HEIGHT * ENEMY_EARTH_DUNGEON_BOSS_SIZE_SCALE
export const ENEMY_EARTH_DUNGEON_BOSS_RADIUS =
  ENEMY_RADIUS * ENEMY_EARTH_DUNGEON_BOSS_SIZE_SCALE
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_DISPLAY_HEIGHT =
  ENEMY_EARTH_DUNGEON_BOSS_HEIGHT
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_OUTLINE_SCALE =
  ENEMY_SLIME_BREATH_OUTLINE_SCALE
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_SCALE_Y_MAX =
  ENEMY_SLIME_BREATH_SCALE_Y_MAX
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_SCALE_Y_MIN =
  ENEMY_SLIME_BREATH_SCALE_Y_MIN
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_DURATION_MS =
  ENEMY_SLIME_BREATH_DURATION_MS
export const ENEMY_EARTH_DUNGEON_BOSS_HP = 450 // 旧 150 の 3 倍（さらに旧 100 の系譜）
export const ENEMY_EARTH_DUNGEON_BOSS_XP_DROP_MULTIPLIER = 20
// 通常スライム速度の 0.75 倍（旧 0.5 の 1.5 倍）
export const ENEMY_EARTH_DUNGEON_BOSS_SPEED_FACTOR = 0.75
export const ENEMY_EARTH_DUNGEON_BOSS_COLOR = 0x78716c
// 召喚間隔。旧 1000ms ÷1.5 → 667ms
export const ENEMY_EARTH_DUNGEON_BOSS_SUMMON_INTERVAL_MS = 667
export const ENEMY_EARTH_DUNGEON_BOSS_MAX_SUMMONED_ENEMIES = 8
export const ENEMY_EARTH_DUNGEON_BOSS_SUMMON_OFFSET_MIN = 48 * WORLD_ENTITY_SCALE
export const ENEMY_EARTH_DUNGEON_BOSS_SUMMON_OFFSET_MAX = 96 * WORLD_ENTITY_SCALE
// 小石連射の周期。旧 5000ms ÷1.5 → 3333ms
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_ATTACK_INTERVAL_MS = 3333
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_BURST_COUNT = 5
// 連射間隔。旧 200ms ÷1.5 → 133ms
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_BURST_SPACING_MS = 133
...
/**
 * 最終ボスが撃つ弾だけ速くする（標準敵弾の 1.5 倍）。
 * ENEMY_BULLET_SPEED 自体は変えない。
 */
export const ENEMY_FINAL_BOSS_PROJECTILE_SPEED = 420
/** earthDungeonBoss の小石弾速度（最終ボス弾） */
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_PROJECTILE_SPEED =
