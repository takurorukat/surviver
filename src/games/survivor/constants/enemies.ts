...
// Wind Plains Stage3 ボス（竜巻・プレイヤー追従・一定間隔で蜂を召喚）
export const ENEMY_WIND_HIVE_BOSS_BREATH_SPRITE_KEY = 'enemy-wind-hive-boss-breath'
export const ENEMY_WIND_HIVE_BOSS_BREATH_SPRITE_PATH =
  'assets/sprites/enemy_wind_hive_boss.png'
export const ENEMY_WIND_HIVE_BOSS_SIZE_SCALE = 1.5
export const ENEMY_WIND_HIVE_BOSS_WIDTH = ENEMY_WIDTH * ENEMY_WIND_HIVE_BOSS_SIZE_SCALE
export const ENEMY_WIND_HIVE_BOSS_HEIGHT = ENEMY_HEIGHT * ENEMY_WIND_HIVE_BOSS_SIZE_SCALE
export const ENEMY_WIND_HIVE_BOSS_RADIUS = ENEMY_RADIUS * ENEMY_WIND_HIVE_BOSS_SIZE_SCALE
export const ENEMY_WIND_HIVE_BOSS_BREATH_DISPLAY_HEIGHT = ENEMY_WIND_HIVE_BOSS_HEIGHT
export const ENEMY_WIND_HIVE_BOSS_BREATH_OUTLINE_SCALE = ENEMY_SLIME_BREATH_OUTLINE_SCALE
export const ENEMY_WIND_HIVE_BOSS_BREATH_SCALE_Y_MAX = ENEMY_SLIME_BREATH_SCALE_Y_MAX
export const ENEMY_WIND_HIVE_BOSS_BREATH_SCALE_Y_MIN = ENEMY_SLIME_BREATH_SCALE_Y_MIN
export const ENEMY_WIND_HIVE_BOSS_BREATH_DURATION_MS = ENEMY_SLIME_BREATH_DURATION_MS
export const ENEMY_WIND_HIVE_BOSS_HP = 25
export const ENEMY_WIND_HIVE_BOSS_XP_DROP_MULTIPLIER = 10
// 通常スライム速度（ENEMY_BASE_SPEED）の 0.5 倍。数値は difficulty で参照する
export const ENEMY_WIND_HIVE_BOSS_SPEED_FACTOR = 0.5
export const ENEMY_WIND_HIVE_BOSS_COLOR = 0xd2b48c
export const ENEMY_WIND_HIVE_BOSS_BEE_SPAWN_INTERVAL_MS = 4000
export const ENEMY_WIND_HIVE_BOSS_BEE_SPAWN_OFFSET_MIN = 32 * WORLD_ENTITY_SCALE
export const ENEMY_WIND_HIVE_BOSS_BEE_SPAWN_OFFSET_MAX = 64 * WORLD_ENTITY_SCALE
export const ENEMY_WIND_HIVE_BOSS_MAX_SUMMONED_BEES = 5
