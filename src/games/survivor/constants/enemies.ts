...
// 従来 HP 25 の 3 倍
export const ENEMY_WIND_HIVE_BOSS_HP = 75
...
/** Hero へ風の玉を1発撃つ間隔（出現直後は即撃ちせず、この間隔後に初弾） */
export const ENEMY_WIND_HIVE_BOSS_WIND_ORB_INTERVAL_MS = 2000
...
export const ENEMY_EARTH_DUNGEON_BOSS_BREATH_DURATION_MS =
  ENEMY_SLIME_BREATH_DURATION_MS
export const ENEMY_EARTH_DUNGEON_BOSS_HP = 100
export const ENEMY_EARTH_DUNGEON_BOSS_XP_DROP_MULTIPLIER = 20
export const ENEMY_EARTH_DUNGEON_BOSS_SPEED_FACTOR = 0.5
export const ENEMY_EARTH_DUNGEON_BOSS_COLOR = 0x78716c
export const ENEMY_EARTH_DUNGEON_BOSS_SUMMON_INTERVAL_MS = 1000
...
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_ATTACK_INTERVAL_MS = 5000
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_BURST_COUNT = 5
export const ENEMY_EARTH_DUNGEON_BOSS_ROCK_BURST_SPACING_MS = 200
...
/** windHiveBoss の風の玉（標準敵弾と同等サイズ／速度／ダメージ、風色） */
export const ENEMY_WIND_ORB_BULLET_TEXTURE_KEY = 'enemy-wind-orb-bullet'
export const ENEMY_WIND_ORB_BULLET_SIZE = 10 * WORLD_ENTITY_SCALE
export const ENEMY_WIND_ORB_BULLET_RADIUS = ENEMY_BULLET_RADIUS
export const ENEMY_WIND_ORB_BULLET_FILL_COLOR = 0x22c55e
export const ENEMY_WIND_ORB_BULLET_HIGHLIGHT_COLOR = 0x86efac
export const ENEMY_WIND_ORB_BULLET_OUTLINE_COLOR = 0x000000
