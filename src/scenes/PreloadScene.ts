...
export class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.audio(SFX_KEY_PLAYER_FIRE_POWER, SFX_PATH_PLAYER_FIRE_POWER)
    this.load.audio(SFX_KEY_PLAYER_HIT_POWER, SFX_PATH_PLAYER_HIT_POWER)
    this.load.audio(SFX_KEY_PLAYER_FIRE_WIND, SFX_PATH_PLAYER_FIRE_WIND)
    this.load.audio(SFX_KEY_PLAYER_HIT_WIND, SFX_PATH_PLAYER_HIT_WIND)
    this.load.audio(SFX_KEY_PLAYER_FIRE_WATER, SFX_PATH_PLAYER_FIRE_WATER)
    this.load.audio(SFX_KEY_PLAYER_HIT_WATER, SFX_PATH_PLAYER_HIT_WATER)
    this.load.audio(SFX_KEY_PLAYER_FIRE_FIRE, SFX_PATH_PLAYER_FIRE_FIRE)
    this.load.audio(SFX_KEY_PLAYER_HIT_FIRE, SFX_PATH_PLAYER_HIT_FIRE)
    this.load.audio(SFX_KEY_PLAYER_FIRE_EARTH, SFX_PATH_PLAYER_FIRE_EARTH)
    this.load.audio(SFX_KEY_PLAYER_HIT_EARTH, SFX_PATH_PLAYER_HIT_EARTH)
    ...
    this.load.audio(SFX_KEY_COIN_PICKUP, SFX_PATH_COIN_PICKUP)
    this.load.audio(SFX_KEY_PLAYER_HURT, SFX_PATH_PLAYER_HURT)
